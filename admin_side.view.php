...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                        ...
                        <a href="upload.view.php" class="dropdown-item" id="">
                            <i class="fas fa-arrow-left mr-2"></i> Back to Upload Page
                        </a>
                    </div>
                </li>
            </ul>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-left">
                                ...
                                <li class="breadcrumb-item active">Admininstrator</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
        ...
        <div class="modal fade" id="searchModal">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <!-- Modal Header -->
                    <div class="modal-header bg-dark">
                        <h4 class="modal-title font-weight-bold"><i class="fa fa-search"></i> Search By Date</h4>
                        <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
                    </div>
        ...
        <div class="modal fade" id="deleteModal">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <!-- Modal Header -->
                    <div class="modal-header bg-dark">
                        <h4 class="modal-title font-weight-bold"><i class="fa fa-trash"></i> Delete By Date</h4>
                        <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
                    </div>
                    ...
                    <div class="modal-body">
                        <form method="POST" action="">
                            ...
                            <div class="form-group">
                                <label for="start-date">From: <i class="text-danger">*</i></label>
                                <input type="date" class="custom-date-input form-control" id="delete_startDate">
                            </div>
                            <div class="form-group">
                                <label for="end-date">To: <i class="text-danger">*</i></label>
                                <input type="date" class="custom-date-input form-control" id="delete_endDate">
                            </div>
                            <div class="modal-footer">
    ...
    <script src="assets/script/admin_side.script.js"></script>
